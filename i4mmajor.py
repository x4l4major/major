...
def pilih_super():
	...
	p = ThreadPool(30)
	p.map(main, id)
        anime("\x1b[32;1m>>>>>>>>>>>>>>>\x1b[31;1mMajor\x1b[37;1mCracker\x1b[32;1m<<<<<<<<<<<<<<<")
	
	print '\x1b[32;1m Hack Krdnaka Kotay Hat [√]^_^ '
	print"\x1b[31;1mHamw Hack Bwakan/\x1b[31;1mCHECKPOINT\x1b[37;1m: \x1b[32;1m"+str(len(oks))+"\x1b[31;1m/\x1b[33;1m"+str(len(cekpoint))
	print ""
	print(logo)
	anime("\x1b[37;1m✓✓✓✓✓✓✓✓✓✓" ) #Major
	anime("==========Major==========")
	anime("Major Cracker")
	anime("==========Cracker==========")
	print ""
